...
class VText extends StatelessWidget {
  const VText(
    ...
    this.textHeightBehavior,
            ...
            'A non-null String must be provided to a VText widget'),
        super(key: key);
  ...
  Widget _buildText(BuildContext context) {
    return Text(
      data,
      style: _textStyle(context)?.merge(TextStyle(fontFamilyFallback: [
        if (style!.fontFamilyFallback != null) ...style!.fontFamilyFallback!,
        style!.fontFamily ?? VFonts.primary
      ])),
    ...
    if (isRequired) {
      return Row(
        ...
        children: [
          ...
          Flexible(
              child: VText(' *', style: TextStyle(color: VColors.red[60]!)))
        ],
      );
    }
